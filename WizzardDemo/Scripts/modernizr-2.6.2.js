...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // This test is only for clip routes in SVG proper, not clip routes on HTML content
    // demo: srufaculty.sru.edu/david.dailey/svg/newstuff/clipRoute4.svg

    // However read the comments to dig into applying SVG cliproutes to HTML content here:
    //   github.com/Modernizr/Modernizr/issues/213#issuecomment-1149491
    tests['svgcliproutes'] = function() {
        return !!document.createElementNS && /SVGClipRoute/.test(toString.call(document.createElementNS(ns.svg, 'clipRoute')));
    };
