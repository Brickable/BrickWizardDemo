...
function HaDateTimePicker(selector, options) {
     ...
     this.options = {
         ...
         disableTime: options.disableTime ? options.disableTime.toString().toLowerCase() === "true" ? true : false : true,
         ...
         resultFormat: options.resultFormat || (timePickerOnly ? "{hour}:{minute} {ampm}" : "{year}-{month}-{day} {t?{hour}:{minute} {ampm}}"),
